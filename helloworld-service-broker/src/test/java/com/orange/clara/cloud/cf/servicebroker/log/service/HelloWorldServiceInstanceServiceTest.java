...
public class HelloWorldServiceInstanceServiceTest {

    @Test
    public void should_return_a_service_instance() throws Exception {
        final HelloWorldServiceInstanceService service = new HelloWorldServiceInstanceService();
